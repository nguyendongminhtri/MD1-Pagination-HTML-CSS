...
var fbBucketName = 'images';
 image = '';
// get elements
var uploader = document.getElementById('uploader_upload');
var fileButton = document.getElementById('fileButton_update');
...
fileButton.addEventListener('change', async function (e) {
    ...
    uploadTask.on(firebase.storage.TaskEvent.STATE_CHANGED, // or 'state_changed'
        function (snapshot) {
            ...
            localStorage.setItem('avatar_student_update', downloadURL);
            let divLocation = document.getElementById("images_update");
